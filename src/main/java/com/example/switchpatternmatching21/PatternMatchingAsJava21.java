...
import com.example.switchpatternmatching21.Shape.Circle;
import com.example.switchpatternmatching21.Shape.Shape;
import com.example.switchpatternmatching21.Shape.Square;
...
//                    -> "A Circle Circle with area of "+ c.area();
//            case Square s -> "A Square with area of " + s.area();
//            default ->  "unknown shape";
//        };
//    }
...
//        return switch (shape) {
//            case Shape s -> "A Circle with area of " + s.area();
//            case Circle c -> "A Circle with area of " + c.area();
//            case Square s -> "A Square with area of " + s.area();
//            default ->  "unknown shape";
//        };
